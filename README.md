...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-0udbz2w.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-0udbz2w.containers.anotherwebservice.com/
...
```
git clone git@github.com:ducminh11102012/container-0udbz2w.git
cd container-0udbz2w
```
...
```
docker attach container-0udbz2w
```
